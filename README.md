...
```javascript
randomStream = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-streams-beta@v0.3.2-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/random-streams-beta/actions/workflows/test.yml/badge.svg?branch=v0.3.2
[test-url]: https://github.com/stdlib-js/random-streams-beta/actions/workflows/test.yml?query=branch:v0.3.2
