...
/**
* Class for creating readable streams which generate a stream of pseudorandom numbers drawn from a beta distribution.
*/
...
interface Constructor {
	...
	*/
	...
	/**
	* Returns an "objectMode" readable stream for generating a stream of pseudorandom numbers drawn from a beta distribution.
	*
	* @param alpha - first shape parameter
	* @param beta - second shape parameter
	* @param options - stream options
